...
# --- THEME DESIGN SYSTEM (Royal Navy Gold) ---
BG = '#0A1128'
SURFACE = '#1C2541'
TEXT = '#F4F5F6'
MUTED = '#8D99AE'
...
FALLBACK_CERTIFICATES = ['Calculations with Vectors and Matrices certificate.pdf', 'certificate battery.pdf', 'certificate simulink onramp.pdf', 'Explore Data with MATLAB Plots certificate.pdf', 'Introduction to Solving Ordinary Differential Equations certificate.pdf', 'Make and Manipulate Matrices.pdf', 'matlab onramp certificate.pdf']
...
def main(page: ft.Page):
    page.title = "Klaudia Kambowe - SiteSpy Portfolio"
        ...
        content=ft.ResponsiveRow([
            ...
            ft.Container(
                ...
                content=ft.Column([
                    ...
                    ft.Text("Klaudia Kambowe", size=34, weight=ft.FontWeight.W_900, color=TEXT),
                    ft.Row([
                        ft.Icon(ft.Icons.WORK_OUTLINE, size=15, color=MUTED),
                        ft.Text("Role: Backend/Firebase (Electrical Department)", color=MUTED, size=14),
                        ft.Container(width=10),
                        ft.Icon(ft.Icons.EMAIL_OUTLINED, size=15, color=MUTED),
                        ft.Text("224085980@students.unam.na", color=MUTED, size=14, selectable=True),
                    ], wrap=True),
                    ft.Row([
                        ft.Icon(ft.Icons.LINK, size=15, color=ACCENT),
                        ft.Text("GitHub Profile: github.com/kambowe", color=ACCENT, size=14, selectable=True)
                    ], wrap=True),
                ], spacing=12)
            ),
    ...
    # Files list
    files_list = []
    for f in ['src/screens/EditProjectScreen.js', 'src/screens/NewProjectScreen.js', 'src/services/projectService.js']:
        files_list.append(
            ft.Container(
                padding=10,
                border_radius=6,
        ...
        content=ft.ResponsiveRow([
            ...
            ft.Container(
                ...
                content=tile_card("My Project Focus", [
                    ft.Text("Project CRUD service and project create/edit screens.", size=14, color=TEXT),
            ...
            ft.Container(
                ...
                content=tile_card("Submission Information", [
                    ...
                    ft.Text('git config user.name "Klaudia Kambowe"\ngit config user.email "224085980@students.unam.na"', size=11, font_family="Consolas", color=TEXT, selectable=True),
                    ft.Divider(color=BORDER),
    ...
    footer = ft.Container(
        ...
        content=ft.Column([
            ft.Text("Klaudia Kambowe | SiteSpy Portfolio Showcase", color=TEXT, size=14, weight=ft.FontWeight.BOLD),
